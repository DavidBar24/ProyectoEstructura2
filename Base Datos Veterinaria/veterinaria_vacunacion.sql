...
CREATE TABLE `vacunacion` (
  ...
  `fecha_ultima_vacunacion` date DEFAULT NULL,
  `fecha_proxima_vacunacion` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_mascota` (`id_mascota`),
  CONSTRAINT `vacunacion_ibfk_1` FOREIGN KEY (`id_mascota`) REFERENCES `mascotas` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-05-30 23:53:06
